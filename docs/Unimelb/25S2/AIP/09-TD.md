...
- Offline Learning 
	- Can handle high stochastic/batch environment✅
...
- Online Learning → One sample use once✅
- Higher generalisation✅
- Lower convergence; may can only approach local optima⚠️
...
- **CANNOT** estimate action values or optimal policies ❌
...
- ✅Take use of experience from other policies
...
| Bootstrapping?                             | ❌                                       | ✅Value Updating relies on the previous estimate of this value (require initial guesses) |
| Variance                                   | ⚠️High - Samples of lots of variables   | ✅Low                                                                                    |
| Bias                                       | Unbiased (return is true target)        | Biased (bootstraps using V(s′))                                                         |
| Exploits Markov property?                  | ❌                                       | ✅                                                                                       |
| Efficiency in Markov environment           | ⚠️Less efficient                        | ✅More efficient                                                                         |
