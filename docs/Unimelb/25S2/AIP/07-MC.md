...
> 
> - Unbiased✅
> - Can only apply to **episodic** (terminating) Markov environment⚠️
...
> - Very low Time Efficiency; Not practical❌
...
Use a soft policy (e.g., ε-greedy) to avoid the need for exploring starts.
...
> [!note] Outcomes: ε-greedy MC
> 
> - Ensures continual exploration by assigning non-zero probability to all actions. ✅
> - More stable than pure greedy MC because it prevents being trapped in suboptimal actions early. ⭐️
> - Slight performance trade-off: exploration introduces variance, but improves long-term value estimation and policy quality. 💭
